      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-grow max-w-4xl mx-auto px-6 py-32 w-full fade-in">
          <div className="mb-12 text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[var(--text-primary)] mb-4">Terms of <span className="text-indigo-500">Service</span></h1>
          ...
          <div className="bg-[var(--glass-card)] border border-[var(--glass-border)] p-8 rounded-3xl shadow-xl space-y-8 leading-relaxed text-sm md:text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[var(--text-primary)] mb-3">2. Prohibited Content</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[var(--text-primary)] mb-3">3. Earnings and Payouts</h2>
