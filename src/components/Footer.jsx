  ...
  return (
    <>
      <style>{`
        ...
        .uk-footer-inner { max-width: 1200px; margin: 0 auto; }
        .uk-footer-grid { display: grid; grid-template-columns: 1.6fr 1fr 1fr; gap: 48px; margin-bottom: 56px; }
        ...
        .uk-footer-logo-icon {
          ...
          font-size: 16px; color: #fff; flex-shrink: 0; box-shadow: 0 0 24px rgba(99,102,241,0.3);
        }
        .uk-footer-logo-text {
          font-family: 'Syne', sans-serif; font-weight: 800; font-size: 18px; letter-spacing: -0.01em;
          background: linear-gradient(135deg, #fff 30%, #a78bfa);
          -webkit-background-clip: text; -webkit-text-fill-color: transparent;
        }
        .uk-footer-desc { color: rgba(255,255,255,0.38); font-size: 14px; line-height: 1.72; max-width: 300px; margin-bottom: 24px; }

        .uk-footer-social { display: flex; gap: 10px; }
        .uk-footer-social a {
          width: 36px; height: 36px; border-radius: 10px;
          background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.07);
          display: flex; align-items: center; justify-content: center;
          color: rgba(255,255,255,0.4); font-size: 15px; text-decoration: none;
        ...
        .uk-footer-col h4 {
          font-family: 'Syne', sans-serif; font-weight: 700; font-size: 13px; letter-spacing: 0.08em; text-transform: uppercase;
        ...
        .uk-footer-col ul a {
          font-size: 14px; font-weight: 400; color: rgba(255,255,255,0.38); text-decoration: none;
          display: inline-flex; align-items: center; gap: 6px; transition: color 0.2s, transform 0.2s;
        }
        .uk-footer-col ul a:hover { color: #fff; transform: translateX(4px); }
        .uk-footer-col ul a::before {
          content: '→'; font-size: 11px; opacity: 0; transform: translateX(-6px);
          transition: opacity 0.2s, transform 0.2s; color: #6366f1;
        }
        ...
        .uk-footer-copy { font-size: 12px; color: rgba(255,255,255,0.25); font-weight: 400; }
        .uk-footer-badge {
          display: inline-flex; align-items: center; gap: 7px; padding: 5px 12px; border-radius: 999px;
          background: rgba(99,102,241,0.08); border: 1px solid rgba(99,102,241,0.15);
          font-size: 11px; font-weight: 600; color: rgba(167,139,250,0.7); letter-spacing: 0.04em;
        }
        .uk-live-dot {
          width: 6px; height: 6px; border-radius: 50%; background: #34d399; animation: ukBlink 1.4s ease-in-out infinite;
        }
        ...
        html.light-mode .uk-footer {
          background: #f8fafc;
          border-top: 1px solid rgba(0, 0, 0, 0.08);
        }
        html.light-mode .uk-footer-logo-text {
          background: linear-gradient(135deg, #1e1b4b 30%, #6366f1);
          -webkit-background-clip: text; -webkit-text-fill-color: transparent;
        }
        html.light-mode .uk-footer-desc { color: rgba(0, 0, 0, 0.6); }
        html.light-mode .uk-footer-social a {
          background: rgba(0, 0, 0, 0.03); border: 1px solid rgba(0, 0, 0, 0.08); color: rgba(0, 0, 0, 0.6);
        }
        html.light-mode .uk-footer-social a:hover {
          background: rgba(99, 102, 241, 0.1); border-color: rgba(99, 102, 241, 0.3); color: #6366f1;
        }
        html.light-mode .uk-footer-col h4 { color: rgba(0, 0, 0, 0.8); }
        html.light-mode .uk-footer-col ul a { color: rgba(0, 0, 0, 0.6); }
        html.light-mode .uk-footer-col ul a:hover { color: #000; }
        html.light-mode .uk-footer-bottom { border-top: 1px solid rgba(0, 0, 0, 0.08); }
        html.light-mode .uk-footer-copy { color: rgba(0, 0, 0, 0.5); }
      `}</style>
      ...
      <footer className="uk-footer">
        <div className="uk-footer-inner">
          ...
          <div className="uk-footer-bottom">
            <p className="uk-footer-copy">© {year} URLKING. All rights reserved.</p>
            <div className="uk-footer-badge">
              <span className="uk-live-dot" /> All systems operational
            </div>
          </div>
        </div>
      </footer>
